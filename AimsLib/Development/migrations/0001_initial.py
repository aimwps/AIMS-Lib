# Generated by Django 3.2.5 on 2021-08-09 16:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('week_reset_on', models.CharField(choices=[('start date day', 'The day of the week you start your tracker'), ('members profile', 'The day set on your user profile')], default='start date day', max_length=100)),
                ('day_reset_on', models.CharField(choices=[('midnight', 'midnight'), ('sleep setting', 'your sleep setting')], default='midnight', max_length=100)),
